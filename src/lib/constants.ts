...
export const BSKY_SERVICE = 'https://pds.mysky.local.social'
export const PUBLIC_BSKY_SERVICE = 'https://public.api.mysky.local.app'
export const DEFAULT_SERVICE = BSKY_SERVICE
const HELP_DESK_LANG = 'en-us'
export const HELP_DESK_URL = `https://blueskyweb.zendesk.com/hc/${HELP_DESK_LANG}`
export const EMBED_SERVICE = 'https://embed.mysky.local.app'
export const EMBED_SCRIPT = `${EMBED_SERVICE}/static/embed.js`
export const BSKY_DOWNLOAD_URL = 'https://mysky.local.social/download'
...
export const DISCOVER_DEBUG_DIDS: Record<string, true> = {
  ...
  'did:plc:tgqseeot47ymot4zro244fj3': true, // iwsmith.pds.mysky.local.social
  'did:plc:2dzyut5lxna5ljiaasgeuffz': true, // mrnuma.pds.mysky.local.social
}
...
export const PROD_LINK_META_PROXY = 'https://cardyb.mysky.local.app/v1/extract?url='
...
export const STATUS_PAGE_URL = 'https://status.mysky.local.app/'
...
export const FOODIOS_WELCOME_ACCOUNT_DID = 'did:plc:hu7sh5pz4vxroyq3rmyuylh7'
...
export const GIF_SERVICE = 'https://gifs.mysky.local.app'
...
export const VIDEO_SERVICE = 'https://video.mysky.local.app'
export const VIDEO_SERVICE_DID = 'did:web:video.mysky.local.app'
...
export const urls = {
  website: {
    blog: {
      initialVerificationAnnouncement: `https://pds.mysky.local.social/about/blog/04-21-2025-verification`,
    },
  },
}

export const PUBLIC_APPVIEW = 'https://bsky.mysky.local.app'
export const PUBLIC_APPVIEW_DID = 'did:web:api.mysky.local.app'
