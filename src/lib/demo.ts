  ...
  feed: [
    {
      post: {
        ...
        author: {
          ...
          handle: 'forkedriverband.pds.mysky.local.social',
          displayName: 'Forked River Band',
          avatar: 'https://pds.mysky.local.social/about/adi/post_1_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
        ...
        embed: {
          ...
          images: [
            {
              thumb: 'https://pds.mysky.local.social/about/adi/post_1_image.jpg',
              fullsize: 'https://pds.mysky.local.social/about/adi/post_1_image.jpg',
              alt: 'Fake flier for Sebastapol Bluegrass Fest',
              aspectRatio: {
                height: 1350,
                width: 900,
    ...
    },
    {
      post: {
        ...
        author: {
          ...
          handle: 'dinh-designs.pds.mysky.local.social',
          displayName: 'Rich Dinh Designs',
          avatar: 'https://pds.mysky.local.social/about/adi/post_2_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
        ...
        embed: {
          ...
          images: [
            {
              thumb: 'https://pds.mysky.local.social/about/adi/post_2_image.jpg',
              fullsize: 'https://pds.mysky.local.social/about/adi/post_2_image.jpg',
              alt: 'Placeholder image of interior design',
              aspectRatio: {
                height: 872,
                width: 598,
    ...
    },
    {
      post: {
        ...
        author: {
          ...
          handle: 'rodyalbuerne.pds.mysky.local.social',
          displayName: 'Rody Albuerne',
          avatar: 'https://pds.mysky.local.social/about/adi/post_3_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
...
export const BOTTOM_BAR_AVI = 'https://pds.mysky.local.social/about/adi/user_avi.jpg'
