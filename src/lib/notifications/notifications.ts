...
/**
 * @private
 * Registers the device's push notification token with the Opensky server.
 */
...
/**
 * Hook to register the device's push notification token with the Opensky. If
...
/**
 * Hook to get the device push token and register it with the Opensky server.
...
/**
 * Hook to register the device's push notification token with the Opensky
...
export function useNotificationsRegistration() {
  ...
  useEffect(() => {
    ...
    /**
     * Register the push token with the Opensky server, whenever it changes.
