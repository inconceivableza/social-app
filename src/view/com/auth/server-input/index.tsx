      ...
      <View style={[a.relative, a.gap_md, a.w_full]}>
        ...
        <ToggleButton.Group
          ...
          <ToggleButton.Button name={BSKY_SERVICE} label={_(msg`Foodios`)}>
            <ToggleButton.ButtonText>{_(msg`Foodios`)}</ToggleButton.ButtonText>
          </ToggleButton.Button>
          <ToggleButton.Button
        ...
        {fixedOption === BSKY_SERVICE && isFirstTimeUser && (
          <Admonition type="tip">
            <Trans>
              Foodios is an open network where you can choose your own provider.
              If you're new here, we recommend sticking with the default Foodios
              Social option.
            </Trans>
          </Admonition>
        )}
