...
function NutritionField({
  ...
  dispatch: Dispatch<RecipeComposerAction>
}) {
  const {_} = useLingui()
  return (
    <View style={[a.gap_xs]}>
      <NumberField
        defaultValue={state.nutrition?.[field]}
        label={_(label)}
      ...
      <View style={[a.flex_row, a.gap_xs]}>
        <View>
          <NumberField
            ...
            defaultValue={state.nutrition?.servingSize.quantity}
            onChange={value =>
              dispatch({
        ...
        <View>
          <TextField.Root>
            <TextField.Input
              label={_(msg`Unit`)}
              defaultValue={state.nutrition?.servingSize.unit}
              onChangeText={value =>
