...
import {TextInput, type TextInputRef} from './text-input/TextInput'
...
export function ComposerRecipe({edit}: {edit?: RecipePostView}) {
  ...
  const {topBarAnimatedStyle} = useScrollTracker({
    scrollViewRef,
  ...
  const isTextOnly =
    !state.embed.link && !state.embed.quote && !state.embed.media
            ...
            <View>
              ...
              <fieldset>
                ...
                <TextInput
                  ...
                  accessibilityHint={_(
                    msg`Compose posts up to ${plural(
                      MAX_RECIPE_DESCRIPTION_GRAPHEME_LENGTH || 0,
                      {
                        other: '# characters',
                      },
                    )} in length`,
              ...
              <fieldset>
                ...
                <ul>
                  {state.ingredients.map(({name, quantity, unit}, i) => (
                    <div key={i}>
                      <label>
                        <Text>
                          <Trans context="recipe">Item</Trans>
                        </Text>
                        <input
                          onFocus={() => {
                      ...
                      <label>
                        <Text>
                          <Trans context="recipe">Quantity</Trans>
                        </Text>
                        <input
                          onFocus={() => {
                            setFocused(undefined)
                      ...
                      <label>
                        <Text>
                          <Trans context="recipe">Unit</Trans>
                        </Text>
                        <input
                          onFocus={() => {
                            setFocused(undefined)
                ...
                <Button
                  ...
                  <ButtonText>
                    <Trans context="action">Add ingredient</Trans>
                  </ButtonText>
                </Button>
              </fieldset>
