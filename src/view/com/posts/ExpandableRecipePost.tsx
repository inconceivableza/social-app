...
export function ExpandedRecipePost({
    ...
    return <View style={[a.gap_xs]}>
        ...
        <View style={a.gap_xs}>
            ...
            {record.recipeCategory?.length && <View style={[a.flex_row, a.align_start, a.gap_sm]}>
                <Text>{`${plural(record.recipeCategory.length, {
                    one: 'Category',
                    other: 'Categories'
                })}:`}</Text>
                <View style={[a.flex_row, a.gap_xs, a.flex_wrap,  a.flex_1]}>
                    {dedupHierarchyOptions(record.recipeCategory.flatMap(path => {
            ...
            {record.suitableForDiet?.length && <View style={[a.flex_row, a.align_start, a.gap_sm]}>
                <Text>{`${plural(record.suitableForDiet.length, {
                    one: 'Suitable for diet',
                    other: 'Suitable for diets'
                })}:`}</Text>
                <View style={[a.flex_row, a.gap_xs, a.flex_wrap, a.flex_1]}>
                    {dedupHierarchyOptions(record.suitableForDiet.flatMap(path => {
            ...
            {record.recipeCuisine?.length && <View style={[a.flex_row, a.align_start, a.gap_sm]}>
