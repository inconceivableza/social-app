...
>) => {
  ...
  const profile = React.useMemo(() => {
    ...
    mockedProfile.avatar = 'https://pds.mysky.local.social/about/images/favicon-32x32.png'
    // @ts-expect-error ProfileViewBasic is close enough -esb
    mockedProfile.banner =
      'https://pds.mysky.local.social/about/images/social-card-default-gradient.png'
