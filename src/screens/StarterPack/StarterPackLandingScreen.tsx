    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join Opensky`)}
              onPress={onJoinPress}
              variant="solid"
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join Opensky</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.TitleText>
          <Trans>Download Opensky</Trans>
        </Prompt.TitleText>
        <Prompt.DescriptionText>
          <Trans>
            The experience is better in the app. Download Opensky now and we'll
      ...
      {isWeb && (
        <meta
          ...
          content="app-id=xyz.mysky.app, app-clip-bundle-id=xyz.mysky.app.AppClip, app-clip-display=card"
        />
      )}
    </View>
  )
      ...
      <View style={[a.flex_1, a.px_lg, {marginTop: 250}]}>
        ...
        <View style={[a.gap_md, {zIndex: 2}]}>
          <Text
            ...
            Download Opensky to get started!
          </Text>
