...
class ViewController: UIViewController, WKScriptMessageHandler, WKNavigationDelegate {
  let defaults = UserDefaults(suiteName: "group.app.mysky")
  ...
  override func viewDidLoad() {
    ...
    self.webView?.load(URLRequest(url: URL(string: "https://mysky.local.social/?splash=true&clip=true")!))
  }
