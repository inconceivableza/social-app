...
* URL scheme: `https://foodios.app/profile/*/post/*`
* API endpoint: `https://embed.foodios.app/oembed`

Request params:

- `url` (required): support both AT-URI and foodios.app URL
...
- `provider_name` (optional): "Foodios Social"
- `provider_url` (optional): "https://foodios.app"
...
```
<link rel="alternate" type="application/json+oembed" href="https://embed.foodios.app/oembed?format=json&url=https://foodios.app/profile/bnewbold.net/post/abc123" />
```


## iframe URL

`https://embed.foodios.app/embed/<did>/app.bsky.feed.post/<rkey>`
`https://embed.foodios.app/static/embed.js`
