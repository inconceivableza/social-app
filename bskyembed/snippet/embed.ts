...
const EMBED_URL = 'https://embed.mysky.local.app'
...
/**
 * Listen for messages from the Opensky embed iframe and adjust the height of
 ...
 * and initialize them as Opensky embeds.
 *
