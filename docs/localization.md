...
We want the official Opensky app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://bluesky.crowdin.com/bluesky-social) or open an issue on the [Opensky app repo on GitHub](https://github.com/bluesky-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - Opensky Crowdin: https://bluesky.crowdin.com/bluesky-social
