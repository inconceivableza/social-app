...
> TestFlight app itself, delete the Opensky app entirely, and re-install from
> the App Store.
...
>
> Project @blueskysocial/bluesky with bundle identifier "xyz.mysky.app" is configured with buildNumber 1011.
> ✔ What version would you like to set? … 1009
>
> npx eas build:version:set -p android
>
> Project @blueskysocial/bluesky with application ID "xyz.mysky.app" is configured with versionCode 641.
...
> npx eas build:version:set -p ios
>
> Project @blueskysocial/bluesky with bundle identifier "xyz.mysky.app" is configured with buildNumber 1009.
> ✔ What version would you like to set? … 1011
>
> npx eas build:version:set -p android
>
> Project @blueskysocial/bluesky with application ID "xyz.mysky.app" is configured with versionCode 639.
