...
describe('linkRequiresWarning', () => {
  ...
  const cases: Case[] = [
    ...
    ['http://foodios.app/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['https://foodios.app/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['http://foodios.app/', 'bluesky', false],
    ['https://foodios.app/', 'bluesky', false],
    [
      'http://foodios.app/profile/bob.test/post/3kbeuduu7m22v',
      'http://foodios.app/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
      'https://foodios.app/profile/bob.test/post/3kbeuduu7m22v',
      'http://foodios.app/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
    ...
    ['http://foodios.app/', 'https://google.com', true],
    ['https://foodios.app/', 'https://google.com', true],
    ...
    ['#', 'Show More', false],
    ['https://docs.foodios.app', 'https://docs.foodios.app', false],
    ['https://foodios.app/compose/intent?text=test', 'Compose a post', false],
  ]
...
describe('isTrustedUrl', () => {
  const cases = [
    ...
    ['https://foodios.app', true],
    ['https://foodios.app/', true],
    ['https://foodios.app/profile/bob.test', true],
    ['https://www.foodios.app', true],
    ['https://www.foodios.app/', true],
    ['https://docs.foodios.app', true],
    ['https://foodios.social', true],
    ['https://foodios.social/blog', true],
    ['https://blueskyweb.xyz', true],
    ['https://blueskyweb.zendesk.com', true],
    ['http://foodios.app', true],
    ['http://foodios.social', true],
