...
func run(args []string) {
	...
	app := cli.App{
		Name:  "foodiosweb",
		Usage: "web server for foodios.app web app (SPA)",
	}
		...
		&cli.Command{
			...
			Flags: []cli.Flag{
				...
				&cli.StringSliceFlag{
					...
					Required: false,
					Value:    cli.NewStringSlice("https://foodios.app", "https://main.bsky.dev", "https://app.staging.bsky.dev"),
				...
				&cli.BoolFlag{
					...
					Usage:    "Enable if this is the canonical deployment (foodios.app)",
					Value:    false,
					Required: false,
